...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Rohit"<<endl;
        string phrase = "Good Morning Master Rohit";
        ...
        cout<< "Good Afternoon Master Rohit"<<endl;
        string phrase = "Good Afternoon Master Rohit";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Rohit"<<endl;
        string phrase = "Good Evening Master Rohit";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER ROHIT |"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER ROHIT";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="rohit")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Rohit...."<<endl<<endl;

                string phrase = "How can i help you Master Rohit";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Rohit....."<<endl;
                    string phrase = "Hello Master Rohit";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Rohit !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Rohit !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    mciSendString(_T("open \"despacito_justin_bieber.mp3\" type mpegvideo alias mp3"), NULL, 0, NULL);
                ...
                else if(command=="open photo")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,_T("open"),_T("avengers.png"),NULL, NULL, SW_NORMAL);
                }


                else if(command=="open roadmap_CP book")
                {
                    cout<<"open roadmap_CP book"<<endl;
                    string phrase = "open roadmap_CP book";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,_T("open"),_T("C:\\Users\\Rohit Yadav\\roadmap_CP.pdf"),NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,_T("open"),_T("C:\\Users\\Rohit\\Documents\\Zoom\\edit distance.mp4"),NULL, NULL, SW_NORMAL);
                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Master Rohit, see you soon!"<<endl;
                    string phrase = "Good Bye Master Rohit, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
